              ...
              {Object.entries(galleryItemsByCategory).map(([categoryId, items]) => (
                <section key={categoryId} className="space-y-8">
                  ...
                  <div className="text-center space-y-3">
                    <h2 className="font-serif text-4xl md:text-4xl text-foreground">
                      {getCategoryName(categoryId)}
                    </h2>
                    <div className="flex items-center justify-center gap-4">
                        <div className="h-px bg-foreground/50 w-24"></div>
                        <div className="w-2 h-2 bg-foreground/50 rotate-45"></div>
                        <div className="h-px bg-foreground/50 w-24"></div>
                    </div>
                  </div>
