                ...
                <div className="space-y-12">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h2 className="font-serif text-2xl text-primary mb-2">Adresse</h2>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h2 className="font-serif text-2xl text-primary mb-2">Téléphone</h2>
                        <a 
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h2 className="font-serif text-2xl text-primary mb-2">Email</h2>
                        <a 
                ...
                <div className="space-y-8">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h2 className="font-serif text-2xl text-primary mb-6">Horaires d'Ouverture</h2>
