                  ...
                  <div className="space-y-8">
                    {category.menu_items.map((item) => (
                      <div key={item.id} className="pb-8">
                        ...
                        <h3 className="font-serif text-xl lg:text-3xl text-primary flex-1">
                            {item.title}
                          </h3>
                          <div className="flex-shrink-0 ml-4 flex items-center gap-3">
                            ...
                            <span className="font-serif text-xl lg:text-3xl text-primary whitespace-nowrap">
                        ...
                        <div className="flex items-center justify-center mt-6">
                          ...
                          <div className="w-1.5 h-1.5 bg-primary rotate-45 mx-4"></div>
                          <div className="h-px bg-primary flex-1 max-w-[100px]"></div>
                        </div>
                      </div>
                    ))}
